...
-- ----------------------------
-- Sequence structure for score_serno_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."score_serno_seq";
CREATE SEQUENCE "public"."score_serno_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 200
...
INSERT INTO "public"."project" VALUES ('B001', '001A', '專案二', '2019-02-26 18:41:17', '2019-06-07 19:46:17');
...
SELECT setval('"public"."projectpermission_projectpermission_serno_seq"', 11, true);
SELECT setval('"public"."score_serno_seq"', 204, false);
ALTER SEQUENCE "public"."teammember_teammember_serno_seq"
OWNED BY "public"."teammember"."teammember_serno";
SELECT setval('"public"."teammember_teammember_serno_seq"', 11, true);
ALTER SEQUENCE "public"."work_work_serno_seq"
OWNED BY "public"."work"."work_serno";
SELECT setval('"public"."work_work_serno_seq"', 11, true);
ALTER SEQUENCE "public"."workhint_work_serno_seq"
OWNED BY "public"."workhint"."work_serno";
SELECT setval('"public"."workhint_work_serno_seq"', 11, true);
ALTER SEQUENCE "public"."workhint_workhint_serno_seq"
OWNED BY "public"."workhint"."workhint_serno";
SELECT setval('"public"."workhint_workhint_serno_seq"', 11, true);
