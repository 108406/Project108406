...
-- ----------------------------
SELECT setval('"public"."adminpush_adminpush_serno_seq"', 101, false);
SELECT setval('"public"."list_list_serno_seq"', 101, false);
SELECT setval('"public"."listwork_list_serno_seq"', 101, false);
SELECT setval('"public"."listwork_listwork_serno_seq"', 101, false);
SELECT setval('"public"."listwork_work_serno_seq"', 101, false);
SELECT setval('"public"."orddetails_serno_seq"', 3001, false);
SELECT setval('"public"."projecthint_projecthint_serno_seq"', 101, false);
SELECT setval('"public"."projectlist_list_serno_seq"', 101, false);
SELECT setval('"public"."projectlist_projectlist_serno_seq"', 101, false);
SELECT setval('"public"."projectpermission_projectpermission_serno_seq"', 101, false);
SELECT setval('"public"."score_serno_seq"', 204, false);
SELECT setval('"public"."teammember_teammember_serno_seq"', 101, false);
SELECT setval('"public"."work_work_serno_seq"', 101, false);
SELECT setval('"public"."workhint_work_serno_seq"', 101, false);
SELECT setval('"public"."workhint_workhint_serno_seq"', 101, false);
